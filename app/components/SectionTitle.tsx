  ...
  return (
    <>
      ...
      <div className="flex items-center justify-between px-4 space-x-4">
        ...
        <h3 className="hidden font-semibold transition duration-300 text-neptune-500 hover:text-neptune-600 dark:text-amber-500/90 md:block whitespace-nowrap dark:hover:text-amber-500">
          <Link href={href}>
            <a>
