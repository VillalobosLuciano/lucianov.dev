...
export default function Index({ projects }) {
  ...
  return (
    <>
      ...
      <Container>
        <div className="pb-6 divide-y lg:pb-14 divide-teal-600/30 dark:divide-yellow-500/30">
              ...
              <div className="flex flex-wrap pb-8">
                <RadioGroup.Option
                  ...
                  className={({ active, checked }) =>
                    clsx(
                      active
                        ? "ring-1 ring-teal-600/50 dark:ring-amber-500/50"
                        : "",
                      checked
                        ? "border dark:border-amber-500/20 dark:text-amber-500/90 border-teal-600/20 text-teal-600/90"
